...
internal fun OwnerShopForm.toOwnerShopRequest(): OwnerShopRequest = OwnerShopRequest(
    address = address,
...
private fun String.toPhoneNumber(): String = when (length) {
