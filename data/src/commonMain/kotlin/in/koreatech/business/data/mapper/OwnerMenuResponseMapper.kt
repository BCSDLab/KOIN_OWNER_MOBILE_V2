...
internal fun OwnerMenuCategoryResponse.toOwnerMenuCategory(): OwnerMenuCategory =
    OwnerMenuCategory(
        id = id,
        name = name,
...
internal fun OwnerMenuItemResponse.toOwnerMenu(): OwnerMenu =
    OwnerMenu(
        id = id,
        name = name.orEmpty(),
        isHidden = isHidden,
...
internal fun OwnerMenuDetailResponse.toOwnerMenuDetail(): OwnerMenuDetail =
    OwnerMenuDetail(
        id = id,
        shopId = shopId,
        name = name,
...
internal fun OwnerMenuCategoriesResponse.toOwnerMenuCategoryOptions(): List<OwnerMenuCategoryOption> =
    menuCategories.map { OwnerMenuCategoryOption(id = it.id, name = it.name) }
