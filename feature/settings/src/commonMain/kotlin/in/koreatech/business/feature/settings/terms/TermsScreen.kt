...
@Composable
private fun TermsLoadingContent(modifier: Modifier = Modifier) {
    Column(modifier = modifier.padding(24.dp), verticalArrangement = Arrangement.spacedBy(16.dp)) {
        Box(modifier = Modifier.fillMaxWidth(0.35f).height(28.dp).skeleton())
        repeat(8) { index ->
            Box(
                modifier = Modifier
                    .fillMaxWidth(if (index % 3 == 2) 0.7f else 1f)
                    .height(14.dp)
                    .skeleton()
            )
        }
